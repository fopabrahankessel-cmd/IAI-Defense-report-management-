...
class Report(models.Model):
    ...
    pdf_file = models.FileField(upload_to=report_upload_path, max_length=500)
    preview_image = models.FileField(upload_to='reports/previews/', blank=True, null=True, max_length=500, help_text="Upload a preview image (FileField used to avoid Pillow dependency).")
